...
-- INSERT INTO public.word_master (word, definition) VALUES('severe','adj. harsh or strict' || chr(10) || 'adj. grave, critical');
-- INSERT INTO public.word_master (word, definition) VALUES('shallow','adj. not deep');
-- INSERT INTO public.word_master (word, definition) VALUES('shelter','v. to protect from something harmful');
-- INSERT INTO public.word_master (word, definition) VALUES('shrink','v. to become smaller');
-- INSERT INTO public.word_master (word, definition) VALUES('significant','adj. important, noteworthy');
-- INSERT INTO public.word_master (word, definition) VALUES('source','n. a person, place or thing where something was obtained');
-- INSERT INTO public.word_master (word, definition) VALUES('sparse','adj. thinly scattered');
